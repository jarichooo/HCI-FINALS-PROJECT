  ...
  const html = `
    ...
    <style>
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      <table>
        <thead><tr>
          <th>Code</th><th>Subject</th><th>Description</th>
          <th>Units</th><th>TF</th><th>Lec</th><th>Lab</th><th>Schedule</th>
        </tr></thead>
        <tbody>${rows}</tbody>
      </table>
      <div class="footer">
            ...
            <table style={styles.table}>
              ...
              <tfoot>
                <tr>
                  ...
                  <td style={{ ...styles.tfootTd, textAlign: "center", color: "var(--primary)", fontWeight: 700 }}>{totalUnits}</td>
...
const styles = {
  ...
  table:       { width: "100%", borderCollapse: "collapse", fontSize: "13px", fontFamily: "'Source Sans 3', sans-serif" },
